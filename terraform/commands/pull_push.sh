...
aws ecr get-login-password --region ap-northeast-2 --profile=default --debug |  docker login --username AWS --password-stdin 628034938073.dkr.ecr.ap-northeast-2.amazonaws.com
